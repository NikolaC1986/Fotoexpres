...
const FAQPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Dostava se naplaćuje 400 dinara za porudžbine ispod 5000 dinara. Za porudžbine veće od 5000 dinara, dostava je besplatna."
    },
    {
      icon: <Truck className="w-6 h-6" />,
        ...
        <Card className="p-10 bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Button size="lg" className="bg-orange-600 hover:bg-orange-700 text-white px-8">
              <a href="tel:+381654600046">Pozovite Nas</a>
            </Button>
            <Link to="/prices">
